...
def parse_args():
    parser = argparse.ArgumentParser(description="Missing-image HF baseline runner")
    parser.add_argument(
        "--model",
        default="mixtral",
...
def main():
    args = parse_args()
    output_dir = os.path.join(ROOT_DIR, "MMTabReal", "Results", f"lower-hf-{args.model}")
    ...
    for folder in sorted(os.listdir(DATA_DIR)):
        ...
        print(f"[->] Asking HF model ({args.model}) for {folder} ...")
